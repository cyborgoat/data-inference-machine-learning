...
\begin{document}
	...
	\answer{
		Reference:
		\begin{itemize}
			\item \url{https://www.investopedia.com/terms/o/overfitting.asp}
		\end{itemize}
	}
	\newpage
...
\answer{
	...
	\end{itemize}
		Reference:
		\begin{itemize}
			\item \url{https://www.quora.com/What-is-meant-by-a-benchmark-solution-in-machine-learning}
		\end{itemize}
	...
	\answer{
			\begin{tabular}{|l|l|}
			\hline
			Feature                    & Survival Probability \\ \hline
